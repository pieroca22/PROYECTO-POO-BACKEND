...
public class PedidoRepository {
    ...
    // Al cambiar o asignar pedido se intenta cambiar de estado, se lanza excepcion
    public boolean pedidoYaEntregado(Integer id) {
        String sql = "SELECT es_entregado FROM Pedido WHERE id = ?";
